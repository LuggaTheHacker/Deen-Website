...
export default function App() {
  ...
  // Custom Styles für den Nothing Dot-Grid Background
  const globalStyles = `
    .bg-nothing-grid {
  ...
  const ViewHome = () => (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-24">
      {/* Hero Section */}
      <div className="nothing-card p-8 md:p-16 mb-12 md:mb-24 flex flex-col md:flex-row gap-12 items-center bg-black text-white">
        <div className="flex-1">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button onClick={() => { setIsLoggedIn(true); navTo('upload'); }} className="bg-white text-black px-8 py-4 rounded-full text-sm font-bold hover:bg-zinc-200 transition-colors text-center">
              Fertigung konfigurieren
            </button>
            <button onClick={() => navTo('maschinen')} className="border border-zinc-700 text-white px-8 py-4 rounded-full text-sm font-medium hover:bg-zinc-900 transition-colors text-center">
              Anlagen ansehen
            </button>
          </div>
        </div>
        {/* Abstract Graphic Element simulating hardware logic */}
        <div className="hidden md:flex flex-1 justify-end">
           <div className="w-64 h-64 border-2 border-zinc-800 rounded-full flex items-center justify-center relative">
              ...
              <div className="absolute top-10 left-10 font-mono text-xs text-zinc-600">X: 250</div>
              <div className="absolute bottom-10 right-10 font-mono text-xs text-zinc-600">Y: 250</div>
           </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="nothing-card p-6 md:p-8 hover:border-black transition-colors">
  ...
  const ViewMaschinen = () => (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
        <div className="nothing-card p-8 bg-white flex flex-col justify-between">
          <div>
  ...
  const ViewShop = () => (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {shopItems.map(item => (
          <div key={item.id} className="nothing-card p-6 flex flex-col justify-between hover:shadow-xl transition-shadow">
            <div>
  ...
  const ViewDashboard = () => (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        ...
        <button onClick={() => navTo('upload')} className="bg-black text-white px-6 py-3 rounded-full text-sm font-bold w-full md:w-auto">
          + Neuer Auftrag
        </button>
      </div>
              ...
              {orders.map((order, idx) => (
                <tr key={idx} className="hover:bg-zinc-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-right space-x-2">
                     <button onClick={() => { setSelectedOrder(order); setCurrentView('order-detail'); }} className="text-xs font-bold text-zinc-500 hover:text-black border border-zinc-200 rounded-lg px-3 py-1.5">
                       Details
                     </button>
                     <button onClick={() => handleReOrder(order)} className="text-xs font-bold bg-black text-white rounded-lg px-3 py-1.5 hover:bg-zinc-800">
                       Re-Order
                     </button>
                  </td>
                </tr>
  ...
  const ViewOrderDetail = () => {
    ...
    return (
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16">
        <button onClick={() => setCurrentView('dashboard')} className="text-xs font-mono font-bold text-zinc-400 hover:text-black mb-8 flex items-center gap-2">
          ← ZURÜCK(PORTAL)
        </button>
        
        <div className="nothing-card p-6 md:p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="bg-zinc-50 rounded-2xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between flex-wrap"><span className="text-zinc-500">Datei:</span> <span className="font-mono text-xs font-bold text-black">{selectedOrder.fileName}</span></div>
          ...
          <div className="border-t border-zinc-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <button onClick={() => handleReOrder(selectedOrder)} className="w-full md:w-auto bg-red-600 text-white rounded-full font-bold text-sm px-8 py-4 hover:bg-red-700 transition-colors shadow-lg shadow-red-500/30">
              RE-ORDER INITIATE
            </button>
          </div>
        </div>
  ...
  const ViewUpload = () => (
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      {/* Upload Box */}
      <div className="nothing-card border-2 border-dashed border-zinc-300 bg-zinc-50 p-8 md:p-16 text-center hover:bg-zinc-100 transition-colors cursor-pointer mb-10 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-10">
        {/* Basic Spec */}
        <div className="nothing-card p-6 md:p-8 space-y-5">
        ...
        {/* Add-ons */}
        <div className="nothing-card p-6 md:p-8 space-y-5 border-black/10 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-4 mt-4 border-t border-zinc-100">
              ...
              <button onClick={() => navTo('shop')} className="text-xs font-bold text-black bg-zinc-100 px-3 py-1.5 rounded-lg hover:bg-zinc-200">Shop Öffnen ↗</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="nothing-card bg-black text-white p-6 md:p-8 flex flex-col lg:flex-row justify-between items-center gap-6 sticky bottom-4 z-40 shadow-2xl shadow-black/50">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          ...
          <button 
            ...
            className="bg-white text-black px-8 py-4 rounded-full text-sm font-bold tracking-wide hover:bg-zinc-200 transition-colors w-full sm:w-auto shadow-[0_0_15px_rgba(255,255,255,0.3)]"
          >
            BEAUFTRAGEN
          </button>
        </div>
  ...
  const ViewSupport = () => (
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12">
        <div className="nothing-card p-8 bg-black text-white">
        ...
        <div className="nothing-card p-8 bg-white">
      ...
      <div className="nothing-card p-6 md:p-10 bg-white">
